...
before packages are loaded."
  ...
  (define-key evil-normal-state-map (kbd "H-<right>") 'evil-end-of-line)
  (define-key evil-normal-state-map (kbd "H-<left>") 'evil-first-non-blank)
  (define-key evil-normal-state-map (kbd "H-r") 'undo-tree-redo)
  ...
  (define-key evil-normal-state-map (kbd "C-H-<down>") 'drag-stuff-down)
  (define-key evil-normal-state-map (kbd "C-H-<up>") 'drag-stuff-up)

  ;; eshell extra settings
